ActiveAdmin.register SiteSetting do
  # permit existing site fields plus new hero_caption and hero_alt
  ...
  form html: { multipart: true } do |f|
    ...
    f.inputs "Site Settings" do
      ...
      f.input :hero_image, as: :file, label: "Hero image", hint: (f.object.hero_image.attached? ? image_tag(url_for(f.object.hero_image), style: "max-width: 300px; display:block; margin-bottom:8px;") : content_tag(:span, "No hero image"))
